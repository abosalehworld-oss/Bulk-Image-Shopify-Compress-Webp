...
### 3 طرق للإدخال — اختر الأنسب:

**الطريقة أ — صور مفردة (لو كل صورة = منتج مختلف)**
```
اختر الصور مباشرة ← الأداة تعمل كل شيء تلقائياً
photo1.jpg  →  photo1-product-image.webp
photo2.jpg  →  photo2-product-image.webp
```
> ✅ لا تحتاج مجلدات — الكود يستخدم اسم الصورة كاسم المنتج

**الطريقة ب — مجلدات (لو عندك أكتر من صورة لنفس المنتج)**
```
📁 my_products/
├── 📁 tom-ford-tobacco-vanille/   ← منتج 1
│   ├── photo1.jpg
│   └── photo2.jpg
├── 📁 xerjoff-naxos/              ← منتج 2
│   └── img1.png
```
> 💡 اسم المجلد = اسم المنتج في الـ SEO

**الطريقة ج — ZIP أو RAR**
```
اضغط ZIP على المجلدات → اختر الملف في الأداة
```
> ✅ الأداة تفك الضغط وتتعامل معاه تلقائياً

**② شغّل الأداة**
1. تبويب **🛒 Shopify** → **"Choose Mode"**: `🗜️ Compress Only`
2. **"Input Source"**: `Direct Images / Archive (ZIP/RAR)`
3. اضغط **"Choose Images/ZIP"** واختر صورك أو ZIP أو مجلد
4. اضغط **START** ✅
...
| الحالة | الطريقة |
|---|---|
| كل صورة = منتج مختلف | اختر الصور مباشرة — لا مجلدات |
| أكتر من صورة لنفس المنتج | مجلد لكل منتج |
| ملف مضغوط | ZIP أو RAR — الأداة تفكه تلقائياً |

1. تبويب **🌐 WordPress** → `Direct Images / Archive (ZIP/RAR)`
2. اختر صورك أو ZIP أو مجلداتك
3. اضغط **START** ✅

> 💡 **نصيحة:** لو مش عارف — حط كل صورك في ZIP واحد واختره. الأداة تفهم هي.
